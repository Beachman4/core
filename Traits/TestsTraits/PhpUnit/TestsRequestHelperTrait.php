...
use App;
use App\Base\Exceptions\MissingTestEndpointException;
use App\Base\Exceptions\UndefinedMethodException;
use App\Base\Exceptions\WrongEndpointFormatException;
...
trait TestsRequestHelperTrait
{
     ...
     * @param array $headers
     *
     * @throws \App\Base\Exceptions\UndefinedMethodException
     * 
